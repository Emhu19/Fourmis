...
int main(){
    ...
    stockBois.capaciteMax = 10;
    stockBois.stock = 0;
    stockBois.ressourceStock = bois;
    Piece stockMetal;
    stockMetal.id = 3;
    ...
    stockMetal.capaciteMax = 10;
    stockMetal.stock = 0;
    stockMetal.ressourceStock = metal;
    A.id = 1;
    A.capaciteMax = 10;
